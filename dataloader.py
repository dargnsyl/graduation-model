...
def init_dataloader(dataset_config):
    ...
    _, _, timeseries = final_fc.shape#timeseries为100

    _, node_size, node_feature_size = final_pearson.shape#node_size, node_feature_size均为200
...
##psedo_arr维度是1009×200×200，表示1009个形状[200,200]的单位阵，可能用于表示节点的自环
